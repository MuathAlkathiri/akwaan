...
`../../learning/rejection-history.json`. A previously user-rejected question
...
Treat aliases and titles for the same entity as one answer. Different questions
...
batch diversity before two questions become exact semantic duplicates.
...
questions about the same event, answer, or Asset distinct. Do not classify all
questions sharing an approved structure as duplicates; compare the underlying
semantic challenge and observation.

Gameplay similarity is distinct from semantic duplication: three weapon
recognition questions may have different answers yet still require rotation
