---
name: image-content-designer
description: Acquires, localizes, and validates essential image Assets for Akwaan ContentItems.
---

# Image ContentItem Designer

## Input

An Asset task containing Subject, Content Pattern, required visual observation,
safe destination directory, supported project formats, intended audience accessibility,
...
11. Store only the valid relative local path in the existing ContentItem schema.
...
approve the affected ContentItem.
