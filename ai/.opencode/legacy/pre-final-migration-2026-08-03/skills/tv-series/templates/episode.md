...
Design questions about memorable episode events and story progression. Exact
episode numbering is discouraged because it often becomes production
memorization rather than story experience.
...
Prefer story stage, sequence, or consequence over exact numbering.

### Hard

Use episode-specific details, first appearances, final appearances, or exact episode titles.

Hard questions may require a specific sequence of events or identifying the
story stage from a short scene. They must not rely on arbitrary numbering.

## Episode Title Exception

Use an episode title only when it is itself a famous, fan-discussed story
element rather than production memorization. When allowed:
