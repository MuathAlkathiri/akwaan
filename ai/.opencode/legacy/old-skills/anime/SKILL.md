...
This skill defines how anime questions should be designed for Lammah.

It extends the LAMMAH DESIGN BIBLE and provides anime-specific guidance.

Always read and apply the LAMMAH DESIGN BIBLE before using this skill.
...
Difficulty should come from recognition level.
...
any) belongs in the current Generated Batch.
