...
description: Converts a Lammah question intent into ranked, Media-specific Asset search queries.
---
...
- Subject and Catalog;
- Question Pattern and intended answer;
- scene, event, action, object, location, or sound;
- target Media type and difficulty;
...
Remove a negative term only when the resolved Catalog or Question Pattern
...
observation, Question Pattern, and Media type, then check
