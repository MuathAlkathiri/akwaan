...
const FAMILIES: Array<[RegExp, { title: string; body: string }]> = [
  [
    /NOT_FOUND$/,
    {
      title: "ما لقينا هذه المباراة",
      body: "يمكن الرابط قديم، أو خلصت الجلسة. ارجع للرئيسية وابدأ مباراة جديدة.",
    },
  ],
  [
    /^(SESSION_NOT_ACTIVE|MATCH_CANCELLED)$/,
    {
      title: "خلصت هذه المباراة",
      body: "انقفلت هذه الجلسة. ابدأوا مباراة جديدة متى ما جهزتوا.",
    },
  ],
  [
    /FORBIDDEN$|UNAUTHORIZED/,
    {
      title: "هذه الصفحة مو لك",
      body: "متحكّم المباراة بس يفتح هذه الشاشة.",
    },
  ],
  [
    ...
    {
      title: "الاتصال متوقف",
      body: "تأكد من الشبكة — بنحاول نستعيد الاتصال تلقائياً.",
    },
  ],
  [
    /STALE|CONCURRENT/,
    {
      ...
      body: "تغيّرت المباراة قبل ما يوصل أمرك. حدّثنا الشاشة، وجرّب مرة ثانية.",
    },
  ],
  [
    /^LOAD_FAILED$/,
