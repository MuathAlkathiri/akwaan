...
describe('World Content architecture', () => {
  ...
  it('keeps world-content imports on explicit legacy and live-game integration edges', () => {
    ...
    expect(legacyImporters.sort()).toEqual([
      ...
      'modules/live-game-sessions/application/start-la-tahriqha-gameplay.use-case.ts',
      ...
      'modules/live-game-sessions/domain/la-tahriqha-gameplay.plugin.spec.ts',
      'modules/live-game-sessions/domain/la-tahriqha-gameplay.plugin.ts',
