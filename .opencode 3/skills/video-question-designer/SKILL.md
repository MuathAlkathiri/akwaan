...
9. Inspect frames, subtitles, thumbnails, overlays, audio, and metadata for
   ...
   or replaced before the question is complete.
...
11. Confirm the question requires observation of the clip; a clip illustrating a
...
clips that reveal the answer. A failed Asset blocks that question until repaired
or replaced.
